...
#   Disclaimers: content, quotes, and discussion stem from Stephan J Kaplan's work found 
...
#                I use much of the his work and procedural approach to pre-processing and his corrections
#                to remedy foreign language monologues and not widely available videos.
